...
public class TestScreenshotChartURL {
    ...
    @Test
    public void TestScreenshotDailyChartHNX() throws Exception {
        try {
            ...
            // Get list of stock symbols
            List<String> stockSymbolList = ExcelUtils.getDataInColumnFromTo(sheet,
                    Constant.HNX_STOCK_COLUMN_INDEX,
                    Constant.HNX_STOCK_SYMBOL_START_INDEX, Constant.HSX_STOCK_SYMBOL_END_INDEX);
            ...
            while (i < stockSymbolList.size()) {
                ...
                // Need to change folder each day
                String dailyFileWithPath
                        = FileUtils.getImageFilePath(Constant.HNX_CHART_SCREENSHOT_FOLDER,
                                imageFileName, "png");
                // Take screenshot
                ImageUtils.takeScreenShot(driver, dailyFileWithPath);
                // Thread.sleep(1000);
    ...
    @Test
    public void TestScreenshotDailyChartUPCOM() throws Exception {
        try {
            File hnx_stock_list = new File(Constant.UPCOM_STOCK_LIST);
            ...
            // Get list of stock symbols
            List<String> stockSymbolList = ExcelUtils.getDataInColumnFromTo(sheet,
                    Constant.UPCOM_STOCK_COLUMN_INDEX,
            ...
            while (i < stockSymbolList.size()) {
                ...
                // Need to change folder each day
                String dailyFileWithPath
                        = FileUtils.getImageFilePath(Constant.UPCOM_CHART_SCREENSHOT_FOLDER,
                                imageFileName, "png");
                // Take screenshot
                ImageUtils.takeScreenShot(driver, dailyFileWithPath);
                // Thread.sleep(1000);
